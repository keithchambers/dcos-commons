...
import com.mesosphere.sdk.queue.generator.Generator;
import com.mesosphere.sdk.queue.http.types.RunManager;
import com.mesosphere.sdk.queue.state.SpecStore;
...
public class RunsResource {
    ...
    private static final Logger logger = LoggingUtils.getLogger(RunsResource.class);
